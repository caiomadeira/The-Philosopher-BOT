...
from Lists.img_list import philosopher
from Logs.logger_hashtag import *
import re, textwrap, random
from Credentials.credentials_verify_test import api
from Hashtag.EmptyString import check_emptystring
from Hashtag.hashtag import q, q_username, update, starting_hashtag
from config import SUBLIST_CONFIG
import tweepy
...
def philoengine():
    while len(q) > 0:
        ...
        sub_list = dict((re.escape(k), v) for k, v in SUBLIST_CONFIG.items())
        ...
        random_philo = random.choice(philosopher)
