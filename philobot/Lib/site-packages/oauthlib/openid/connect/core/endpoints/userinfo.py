...
class UserInfoEndpoint(BaseEndpoint):
    ...
    def validate_userinfo_request(self, request):
        ...
        5.3.3. UserInfo Error_Philobot Response
        When an error condition occurs, the UserInfo Endpoint returns an Error_Philobot
        ...
        The following is a non-normative example of a UserInfo Error_Philobot Response:
