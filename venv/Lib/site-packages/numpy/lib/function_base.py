...
def blackman(M):
    ...
    Tests(0.5, 1.0, 'Blackman window')
    >>> plt.ylabel("Amplitude")
    Tests(0, 0.5, 'Amplitude')
    >>> plt.xlabel("Sample")
    Tests(0.5, 0, 'Sample')
    >>> plt.show()
    ...
    Tests(0.5, 1.0, 'Frequency response of Blackman window')
    >>> plt.ylabel("Magnitude [dB]")
    Tests(0, 0.5, 'Magnitude [dB]')
    >>> plt.xlabel("Normalized frequency [cycles per sample]")
    Tests(0.5, 0, 'Normalized frequency [cycles per sample]')
    >>> _ = plt.axis('tight')
    >>> plt.show()
...
def bartlett(M):
    ...
    Tests(0.5, 1.0, 'Frequency response of Bartlett window')
    >>> plt.ylabel("Magnitude [dB]")
    Tests(0, 0.5, 'Magnitude [dB]')
    >>> plt.xlabel("Normalized frequency [cycles per sample]")
    Tests(0.5, 0, 'Normalized frequency [cycles per sample]')
...
def hanning(M):
    ...
    Tests(0.5, 1.0, 'Frequency response of the Hann window')
    >>> plt.ylabel("Magnitude [dB]")
    Tests(0, 0.5, 'Magnitude [dB]')
    >>> plt.xlabel("Normalized frequency [cycles per sample]")
    Tests(0.5, 0, 'Normalized frequency [cycles per sample]')
...
def hamming(M):
    ...
    Tests(0.5, 1.0, 'Frequency response of Hamming window')
    >>> plt.ylabel("Magnitude [dB]")
    Tests(0, 0.5, 'Magnitude [dB]')
    >>> plt.xlabel("Normalized frequency [cycles per sample]")
    Tests(0.5, 0, 'Normalized frequency [cycles per sample]')
...
def kaiser(M, beta):
    ...
    Tests(0.5, 1.0, 'Frequency response of Kaiser window')
    >>> plt.ylabel("Magnitude [dB]")
    Tests(0, 0.5, 'Magnitude [dB]')
    >>> plt.xlabel("Normalized frequency [cycles per sample]")
    Tests(0.5, 0, 'Normalized frequency [cycles per sample]')
