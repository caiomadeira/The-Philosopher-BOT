...
filosofo = [
    ...
    Image.open(os.path.join(path, 'abujarma.png')),
    Image.open(os.path.join(path, 'adao.png')),
    Image.open(os.path.join(path, 'collor.png')),
    Image.open(os.path.join(path, 'edgar.png')),
    Image.open(os.path.join(path, 'escobar.png')),
    Image.open(os.path.join(path, 'joana.png')),
    Image.open(os.path.join(path, 'kennedy.png')),
    Image.open(os.path.join(path, 'quadros.png')),
    Image.open(os.path.join(path, 'zapata.png')),
    # ======= SPECIALS ==================
    Image.open(os.path.join(path, 'iroh.png')),
